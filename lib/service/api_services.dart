...
class ApiServices {
  // API
  static const baseUrlOfAPI = "https://resta.fuudiiapp.com/";
  ...
  static const adsSeenUnlockCharacter = "${baseUrlOfAPI}api/v1/ads-seen-unlock-character";
  static const adsSeenLimitIncrease = "${baseUrlOfAPI}api/v1/ads-seen-limit-increase";
  static const banners = "${baseUrlOfAPI}api/v1/banners";
  static const subscriptions = "${baseUrlOfAPI}api/v1/subscriptions";
  static const suggestionByCategpry = "${baseUrlOfAPI}api/v1/suggestion-by-categpry";
  static const updateProfilePicture = "${baseUrlOfAPI}api/v1/update-profile-picture";
  ...
  static const createUserSubscription = "${baseUrlOfAPI}api/v1/create-user-subscription";
  ...
  static const deletePromsHistory = "${baseUrlOfAPI}api/v1/delete-proms-history";
