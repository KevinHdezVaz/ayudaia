...
class DashBoardTwo extends StatelessWidget {
            ...
            body: controller.isLoading.value
                ...
                : controller.index.value == 0
                    ...
                    : controller.index.value == 1
                        ? const CategoryListScreen(isShowing: true,)
              ...
              items: [
                BottomNavigationBarItem(
                    icon: SvgPicture.asset(
                      ...
                      colorFilter: ColorFilter.mode(controller.index.value == 0 ? ConstantColors.blue04 : ConstantColors.grey03, BlendMode.srcIn),
                    ),
                    label: 'Home'),
                BottomNavigationBarItem(
                  icon: SvgPicture.asset(
                    "assets/images/ic_category.svg",
                    colorFilter: ColorFilter.mode(controller.index.value == 1 ? ConstantColors.blue04 : ConstantColors.grey03, BlendMode.srcIn),
                  ),
                  label: "Category",
                ),
                BottomNavigationBarItem(
                    icon: SvgPicture.asset(
                      ...
                      colorFilter: ColorFilter.mode(controller.index.value == 2 ? ConstantColors.blue04 : ConstantColors.grey03, BlendMode.srcIn),
                    ),
                    label: "Image"),
                BottomNavigationBarItem(
                    icon: SvgPicture.asset(
                      "assets/icons/ic_setting_Icon.svg",
                      colorFilter: ColorFilter.mode(controller.index.value == 3 ? ConstantColors.blue04 : ConstantColors.grey03, BlendMode.srcIn),
                    ),
                    label: "Settings")
              ],
            ),
  ...
  showDialog(BuildContext context) {
    return showModalBottomSheet(
        ...
        builder: (context) {
          return const FractionallySizedBox(heightFactor: 0.99, child: SubscriptionScreen());
        });
  }
}
